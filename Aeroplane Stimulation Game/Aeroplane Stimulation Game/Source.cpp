...
void drawString(float x, float y, float z, void* font, char const* string)
{
	char const* c;
	glRasterPos3f(x, y, z);
...
void welcome()
{
	...
	// Main title
	glColor3f(0.8, 0.8, 0.8);
	drawString(25, 70, 0, GLUT_BITMAP_TIMES_ROMAN_24, "AIRPLANE   SIMULATION   GAME");
	glPopMatrix();
	glColor3f(0, 0, 0);
...
void display()
{
	...
	else if (instflag == true)
	{
		...
		// Instructions Content Set
		glColor3f(0.137, 0.137, 0.556);
		drawString(37, 74, 0, GLUT_BITMAP_TIMES_ROMAN_24, "HOW TO PLAY");

		drawString(23, 69, 0, GLUT_BITMAP_HELVETICA_18, "- Aim: To avoid the obstacles such as buildings");
		drawString(23, 65, 0, GLUT_BITMAP_HELVETICA_18, "         and clouds.");
		drawString(23, 60, 0, GLUT_BITMAP_HELVETICA_18, "- To gain altitude: Click and hold LEFT Mouse key.");
		drawString(23, 54, 0, GLUT_BITMAP_HELVETICA_18, "- To reduce altitude: Release the LEFT Mouse Key.");
		drawString(23, 48, 0, GLUT_BITMAP_HELVETICA_18, "- To speed up the plane: Use the RIGHT mouse key. ");
		drawString(23, 42, 0, GLUT_BITMAP_HELVETICA_18, "- Meter at the bottom shows: distance and level.");
		drawString(23, 36, 0, GLUT_BITMAP_HELVETICA_18, "- As you reach distance multiples by 50, level. ");
		drawString(23, 32, 0, GLUT_BITMAP_HELVETICA_18, "   as well as the speed of the plane.");
	...
	else if (abtflag == true)
	{
		...
		drawString(21, 67, 0, GLUT_BITMAP_HELVETICA_18, "      Created By: ");
		drawString(23, 57, 0, GLUT_BITMAP_HELVETICA_18, "      Sanya Aggarwal ");
		drawString(23, 50, 0, GLUT_BITMAP_HELVETICA_18, "      Vanshika Thapliyal  ");
		drawString(23, 43, 0, GLUT_BITMAP_HELVETICA_18, "      Shreya Saxena  ");
...
int main(int argc, char** argv)
{
	...
	printf("\n\n- Aim: To avoid the obstacles such as buildings and clouds.");
	printf("\n\n\n Instructions: ...!");
	printf("\n\n\n - To gain altitude: Click and hold LEFT Mouse key.");
	printf("\n\n - To reduce altitude: Release the LEFT Mouse Key.");
	printf("\n\n - To speed up the plane: Use the RIGHT mouse key. ");
	printf("\n\n - Meter at the bottom shows : distance and level.");
	printf("\n\n - As you reach distance multiples by 50, level as well as the speed of the plane.\n\n\n");
	printf(" ***********************   ENJOY !!  ****************\n\n");
